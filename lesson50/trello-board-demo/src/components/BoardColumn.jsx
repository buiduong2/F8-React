...
import { addTask, editColumn, removeColumn } from '../redux/boardSlice'
...
export default function BoardColumn({ column, columnIndex }) {
	...
	return (
		<>
			<article className="flex max-h-full flex-col overflow-hidden rounded-lg bg-slate-200">
				...
				<ul className="mx-1 flex flex-col gap-2 overflow-y-auto px-1 scrollbar-thin scrollbar-track-slate-300/80 scrollbar-thumb-slate-400/50">
