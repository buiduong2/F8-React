	...
	return (
		<section className="container mx-auto py-28">
			<div className="mb-20 text-center">
				...
				<Typography variant="lead" color="gray" className="mx-80 p-4">
					Whether you have a mobile app idea that needs to come to
					life or a website that requires a facelift, I&rsquo;m here
					to turn your digital dreams into reality.
				</Typography>
			</div>

			<div className="flex flex-wrap gap-y-20">
				{blogs.map(blog => (
					<Card className="m-0 w-1/4" shadow={false} key={blog.id}>
